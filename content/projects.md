...
**GitHub:** [github.com/metachris](https://github.com/metachris)
...
* [Nash](https://nash.io/) - Cryptocurrency platform and wallet
* [NEO Smart Economy](https://neo.org/contributors) - Smart contract platform
* [City of Zion](https://web.archive.org/web/20191208213537/https://www.cityofzion.io/) - NEO developer community
* [Red Pulse](https://www.redpulse.com/) - Blockchain research platform

**Tech & Open Source:**
* [Google Summer of Code](https://developers.google.com/open-source/gsoc/2008/?hl=en) (2008)
* [One Laptop Per Child (OLPC)](https://en.wikipedia.org/wiki/One_Laptop_per_Child) - Educational technology
* [Metalab Vienna](https://metalab.at/) - Hackerspace and community
* [MeetMe.com](https://www.meetme.com/) - Social discovery platform
* [All About Apps](https://allaboutapps.at/) - Mobile app development
* [Doctors Without Borders](https://www.msf.org/) - Humanitarian aid
...
* [go-boost-utils](https://github.com/flashbots/go-boost-utils) - Eth2 builder API types and signing utilities for Golang

* [eth-reorg-monitor](https://github.com/metachris/eth-reorg-monitor) - Monitor and track Ethereum chain reorganizations

* [go-ethutils](https://github.com/metachris/go-ethutils) - Ethereum data analysis utilities and helpers

* [flashbots utilities](https://github.com/metachris/flashbots) - Flashbots tooling and data analysis suite

* [eth-go-bindings](https://github.com/metachris/eth-go-bindings) - Go bindings for Ethereum smart contracts: ERC20, ERC165, ERC721, ERC777, ERC1155
...
* [PDFx](/pdfx/) - PDF metadata and link extraction tool
...
* [TypeScript + Node.js Boilerplate](https://github.com/metachris/typescript-nodejs-boilerplate/) - Minimal, solid project setup template
...
* [CSS Pivot](https://web.archive.org/web/20111115123715/http://www.csspivot.com/) - Tool to modify and share custom CSS for third-party websites

* [Backend Info](http://www.backendinfo.com/) - Browser extension detecting website backend technologies

* [My Market](https://web.archive.org/web/20111109093104/http://mymarket.cc/) (2010) - Enhanced Android Market app built through reverse engineering
