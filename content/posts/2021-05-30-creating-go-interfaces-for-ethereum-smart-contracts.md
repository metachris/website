...
**Step 3**: Edit `truffle-config.json` to set the Solidity compiler version and adding the abigen pugin:
...
You can use [remix.ethereum.org](http://remix.ethereum.org) to compile smart contracts
