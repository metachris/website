...
This post is an incomplete collection of notes and tips on how I setup and use my computer and tools for development.
...
See also [this post about how I setup my Terminal and Bash]({{< ref "2024-01-04-terminal" >}}).
...
- [**Recommended Extensions**](https://code.visualstudio.com/docs/editor/extension-marketplace)
    ...
    - [**Markdown All in One**](https://marketplace.visualstudio.com/items?itemName=yzhang.markdown-all-in-one) - pretty good for markdown content, but overwrites some default shortcuts (check by going to keyboard shortcut settings and searching for "markdown").
...
I hope that some of these notes and tips might be useful to you, and provide a bit of inspiration on levelling up your personal setup. I'd love to hear your thoughts and ideas about improvements and other tips in the comments below!
